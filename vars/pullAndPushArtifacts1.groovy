...
class ArtifactoryUtils implements Serializable {

    static void pullAndPushArtifacts1(
        def sourceUrl, def sourceRepo, def sourceArtifactPath, 
        def targetUrl, def sourceCredentialsId, def targetCredentialsId
    ) {
